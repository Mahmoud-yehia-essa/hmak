...
class CategoryController extends Controller
{
    ...
    public function storeCategory(Request $request)
    {
        ...
        $request->validate([
            ...
            'category_photo' => 'required|image|mimes:jpeg,png,jpg,gif|max:20480',
        ], [
            ...
            'category_photo.max' => '⚠️ حجم الصورة يجب الا يتعدى 20MB',
        ]);
    ...
    public function editCategortStore(Request $request){
        ...
        $request->validate([
            'category_name' => 'required|string|max:255',
            'category_description' => 'nullable|string',
            'category_photo' => 'image|mimes:jpeg,png,jpg,gif|max:20480',
        ], [
            'category_name.required' => '⚠️ الرجاء اضافة اسم الفئة',
            'category_name.string' => '⚠️ الرجاء التأكد من كتابة الفئة بشكل صحيح',
            'category_name.max' => '⚠️ الرجاء التأكد من عدد احرف الفئة لا يتجاوز 255 حرف',
        ...
        if ($old_img && $old_img !== 'upload/no_image.jpg' && file_exists($old_img)) {
           unlink($old_img);
        }
    ...
    public function deleteCategory($id){
        ...
        if ($category->category_photo && $category->category_photo !== 'upload/no_image.jpg' && file_exists(public_path($category->category_photo))) {
