    ...
    <div class="ps-3">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0 p-0">
                ...
                <li class="breadcrumb-item active" aria-current="page">تعديل مؤلف/مقدم</li>
            </ol>
        </nav>
    </div>
</div>
...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <form method="POST" action="{{ route('update.sound.author') }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9 text-secondary">
                            ...
                            <img id="showImage" src="{{ $author->image_path ? asset($author->image_path) : url('upload/no_image.jpg') }}" alt="Preview" width="120" class="mt-2 rounded-circle border shadow-sm" style="width:100px;height:100px;object-fit:cover;">
