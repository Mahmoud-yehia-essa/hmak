...
<div class="page-content">
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-title pe-3">إضافة فئة فرعية</div>
        <div class="ps-3">
                ...
                <div class="col-lg-10">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('market.sub_categories.store') }}" enctype="multipart/form-data">
                                @csrf
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <select name="market_main_category_id" class="form-select" required>
                                            ...
                                            @foreach($mainCategories as $cat)
                                                <option value="{{ $cat->id }}" {{ old('market_main_category_id') == $cat->id ? 'selected' : '' }}>{{ $cat->name }}</option>
                                            @endforeach
                                        </select>
