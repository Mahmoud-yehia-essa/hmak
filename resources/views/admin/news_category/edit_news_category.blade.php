...
<div class="col-lg-12">
    <div class="card">
        <div class="card-body">
            ...
            <form method="POST" action="{{ route('edit.news.category.store') }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9 text-secondary">
                        ...
                        <img id="showImage" src="{{ $value->image ? asset($value->image) : url('upload/no_image.jpg') }}" alt="Preview" width="100" class="mt-2">
