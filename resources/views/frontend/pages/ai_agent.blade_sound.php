...
.chat-footer { border-top: 1px solid #ddd; background: #fff; padding: 10px; position: sticky; bottom: 0; }
...
function sendMessage(event) {
    ...
    .then(data => {
        ...
        listenBtn.innerHTML = "🔊";
        listenBtn.title = "استمع";
        listenBtn.onclick = () => speakText(answerText);
